// Main application script for the 2026 Weekly Calendar
...
function loadSavedData() {
    const savedData = localStorage.getItem('calendarData2026');
    if (savedData) {
        try {
...
function saveCalendarData() {
    try {
        localStorage.setItem('calendarData2026', JSON.stringify({
